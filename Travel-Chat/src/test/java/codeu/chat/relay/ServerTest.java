...
public final class ServerTest {
  ...
  public void testWriteSuccess() {
    ...
    assertTrue(relay.write(team,
                           ...
                           relay.pack(new Uuid(6), "Group", Time.now()),
  ...
  public void testWriteAndReadSuccess() {
    ...
    for (final Relay.Bundle bundle : read) {
      ...
      assertTrue(Uuid.equals(bundle.group().id(), new Uuid(6)));
  ...
  public void testReadMidHistory() {
    ...
    assertTrue(relay.write(team,
                           ...
                           relay.pack(new Uuid(9), "Conversation", Time.now()),
                           relay.pack(new Uuid(10), "Group", Time.now()),
                           relay.pack(new Uuid(11), "Hello World... again", Time.now())));

    assertTrue(relay.write(team,
                           secret,
                           relay.pack(new Uuid(12), "User", Time.now()),
                           relay.pack(new Uuid(13), "Conversation", Time.now()),
                           relay.pack(new Uuid(14), "Group", Time.now()),
                           relay.pack(new Uuid(15), "Hello World... again", Time.now())));
